function [status, dat, e, sfr50, fitme, lsf, nbin, del2, Con, ...
    Angle, Clip, ESF] = sfrmat5M(io, del, a, mask, npol, wflag, weight)
...
rflag = 0;
[a, mask, nlin, npix, rflag] = rotatev2M(a, mask);  %based on data values
loc = zeros(ncol, nlin);
